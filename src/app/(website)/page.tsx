        ...
        <div className="relative">
          <div className="container px-4 py-8">
            ...
            <div className="mx-auto mt-16 max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg text-blue-200">Slide revolutionizes how you connect with your audience on Instagram. Automate responses and boost engagement effortlessly, turning interactions into valuable business opportunities.</p>
